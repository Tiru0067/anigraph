...
export const AnimeMarqueeCard = ({ anime, uniqueKey }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-t from-background-000 via-background-000/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-2.5 text-left">
